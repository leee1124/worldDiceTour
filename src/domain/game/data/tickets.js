...
export const TICKETS = Object.freeze([
  { id: 'T01', text: '복권 소액 당첨! 150,000원을 받습니다.', effect: { type: TICKET_EFFECTS.GAIN, amount: 150_000 } },
  { id: 'T02', text: '여행 브이로그 대박! 300,000원을 받습니다.', effect: { type: TICKET_EFFECTS.GAIN, amount: 300_000 } },
  { id: 'T03', text: '면세점 세금 환급 75,000원을 받습니다.', effect: { type: TICKET_EFFECTS.GAIN, amount: 75_000 } },
  { id: 'T04', text: '여행자 보험금 225,000원을 받습니다.', effect: { type: TICKET_EFFECTS.GAIN, amount: 225_000 } },
  { id: 'T05', text: '수하물 초과 요금 75,000원을 냅니다.', effect: { type: TICKET_EFFECTS.LOSE, amount: 75_000 } },
  { id: 'T06', text: '여권을 잃어버려 재발급 비용 150,000원을 냅니다.', effect: { type: TICKET_EFFECTS.LOSE, amount: 150_000 } },
  { id: 'T07', text: '호텔 미니바 폭주로 120,000원을 냅니다.', effect: { type: TICKET_EFFECTS.LOSE, amount: 120_000 } },
  { id: 'T08', text: '렌터카 과속 딱지로 90,000원을 냅니다.', effect: { type: TICKET_EFFECTS.LOSE, amount: 90_000 } },
  ...
  { id: 'T15', text: '생일 축하! 다른 모든 플레이어에게서 75,000원씩 받습니다.', effect: { type: TICKET_EFFECTS.COLLECT_FROM_ALL, amount: 75_000 } },
  { id: 'T16', text: '한턱 쏘기! 다른 모든 플레이어에게 45,000원씩 줍니다.', effect: { type: TICKET_EFFECTS.PAY_TO_ALL, amount: 45_000 } },
  { id: 'T17', text: '건물 점검 비용으로 건물 수 × 60,000원을 냅니다.', effect: { type: TICKET_EFFECTS.PAY_PER_BUILDING, amount: 60_000 } },
  { id: 'T18', text: '관광 붐! 보유 도시 수 × 45,000원을 받습니다.', effect: { type: TICKET_EFFECTS.GAIN_PER_CITY, amount: 45_000 } },
