...
| **게임 보드** | 11×11 그리드 외곽 40칸의 정사각 보드. 칸마다 이름 · 가격/통행료 · 소유자 색 띠+무늬 · **건물 배지 3칸(별/빌/호, 지은 것만 채움) · 금색 ★ 랜드마크 리본**. 말은 칸 위 **오버레이 층**에 크게 그려지고(현재 차례는 통통 튐, 내 말은 "나" 배지) 주사위 이동은 **칸을 하나씩 밟아 간다**. 칸을 누르면 상세 시트(소유자 · 건물별 지음/안 지음 · 현재 통행료 · 인수 가격) |
...
| 1바퀴 | 별장 | |
| 2바퀴 | 별장 · 빌딩 | |
| 3바퀴 이상 | 별장 · 빌딩 · 호텔 | 3종을 갖춘 **다음** 기회에 랜드마크 |
...
- 인수한 도시의 건물은 인수자의 바퀴와 무관하게 그대로 남는다(3종이 완성된 도시를 인수하면 곧바로 랜드마크를 지을 수 있다).
